...
namespace Sisus.Init
{
	...
	public static class InitArgs
    {
		...
		public static bool TryGet<TClient, TArgument>(Context context, [NotNull] TClient client, out TArgument argument) where TClient : IArgs<TArgument>
		{
			...
			if(context == Context.MainThread && Service.TryGetFor(client, out argument))
			{
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument>
		{
			...
			if(context == Context.MainThread && Service.TryGetFor(client, out firstArgument) && Service.TryGetFor(client, out secondArgument))
			{
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
		{
			...
			if(context == Context.MainThread && Service.TryGetFor(client, out firstArgument) && Service.TryGetFor(client, out secondArgument) && Service.TryGetFor(client, out thirdArgument))
			{
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		{
			...
			if(context == Context.MainThread && Service.TryGetFor(client, out firstArgument) && Service.TryGetFor(client, out secondArgument)
				&& Service.TryGetFor(client, out thirdArgument) && Service.TryGetFor(client, out fourthArgument) && Service.TryGetFor(client, out fifthArgument))
			{
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
		{
			...
			if(context == Context.MainThread && Service.TryGetFor(client, out firstArgument) && Service.TryGetFor(client, out secondArgument)
				&& Service.TryGetFor(client, out thirdArgument) && Service.TryGetFor(client, out fourthArgument) && Service.TryGetFor(client, out fifthArgument) && Service.TryGetFor(client, out sixthArgument))
			{
				return true;
			}
