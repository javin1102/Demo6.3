...
namespace Sisus.Init.EditorOnly.Internal
{
	...
	internal static class ServiceTagDrawer
	{
		...
		private static Clients GetClientVisibility(Component component, IEnumerable<Type> definingTypes)
		{
			...
			{
				if(ServiceUtility.TryGetClients(component, definingType, out var toClients))
				{
					return toClients;
				}
				//ServiceUtility.TryGetClientScope()
				//ServiceUtility.TryGetServiceScope()
				//ServiceUtility.TryGetServiceVisibility
				//ServiceUtility.TryGetServiceAvailability

				//if(ScopedServiceUtility.TryGetServiceToClientVisibility(component, definingType, out var toClients))
				//{
				//	return toClients;
				//}
			}
