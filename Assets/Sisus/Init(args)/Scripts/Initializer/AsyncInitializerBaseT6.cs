...
{
	/// <summary>
	/// A base class for a component that can be used to specify the six arguments used to asynchronously initialize an object that implements
	...
	public abstract class AsyncInitializerBase<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : MonoBehaviour, IInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, IValueProvider<TClient>
		#if UNITY_EDITOR
		...
		where TClient : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
	{
		...
		bool IInitializerEditorOnly.HasNullArguments => IsNull(FirstArgument) || IsNull(SecondArgument) || IsNull(ThirdArgument) || IsNull(FourthArgument) || IsNull(FifthArgument) || IsNull(SixthArgument);
		...
		public TClient InitTarget()
		{
			...
			if(TryInitTarget(FirstArgument, SecondArgument, ThirdArgument, FourthArgument, FifthArgument, SixthArgument))
			{
				DestroySelf();
			}
		...
		[NotNull]
		protected virtual bool TryInitTarget(TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument, TFifthArgument fifthArgument, TSixthArgument sixthArgument)
        {
			if(firstArgument == Null || secondArgument == Null || thirdArgument == Null || fourthArgument == Null || fifthArgument == Null || sixthArgument == Null)
			{
				return false;
			}
            ...
            if(target == null)
            {
                return target = gameObject.AddComponent<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument);
            }
		...
		{
			while(!TryInitTarget(FirstArgument, SecondArgument, ThirdArgument, FourthArgument, FifthArgument, SixthArgument))
			{
				yield return null;
			}
