...
{
	/// <summary>
	/// A base class for a component that can be used to specify the three arguments
	...
	public abstract class AsyncInitializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument> : AsyncInitializerBase<TClient, TFirstArgument, TSecondArgument, TThirdArgument> where TClient : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>
	{
		[SerializeField]
