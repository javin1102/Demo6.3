...
namespace Sisus.Init
{
	...
	public abstract class ScriptableObjectInitializerBase<TClient, TFirstArgument, TSecondArgument, TThirdArgument> : ScriptableObject,
		...
		where TClient : ScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>
	{
		...
		protected virtual TClient InitTarget(TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument)
        {
            if(target == null)
            {
                return target = Create.Instance<TClient, TFirstArgument, TSecondArgument, TThirdArgument>(firstArgument, secondArgument, thirdArgument);
            }
			
			if(target is ScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument> monoBehaviourT)
			{
