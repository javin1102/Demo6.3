		...
		*/
        ...
        Pass
		{
			...
			)
			{
				...
				/*ase_local_var:op*/float3 positionOS = TransformWorldToObject( posInput.positionWS );
				/*ase_local_var:vp*/float3 positionVS = TransformWorldToView( posInput.positionWS );
