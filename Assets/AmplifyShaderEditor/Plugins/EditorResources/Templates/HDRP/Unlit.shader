	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Alpha Clipping,InvertActionOnDeselection:Force Off,Material Toggle:Force Off
				...
				Force Off:SetShaderProperty:_AlphaCutoffEnable,//[HideInInspector][ToggleUI] _AlphaCutoffEnable("Alpha Cutoff Enable", Float) = 0
				...
				Material Toggle:SetShaderProperty:_AlphaCutoffEnable,[HideInInspector][ToggleUI] _AlphaCutoffEnable("Alpha Cutoff Enable", Float) = 0
			Option:  Use Shadow Threshold:Force Off,Material Toggle:Force Off
				...
				Force Off,disable:SetShaderProperty:_UseShadowThreshold,//[HideInInspector][ToggleUI] _UseShadowThreshold("Use Shadow Threshold", Float) = 0
				Material Toggle:SetDefine:_ALPHATEST_SHADOW_ON
				Material Toggle:ShowPort:Alpha Clip Threshold Shadow
				Material Toggle:SetShaderProperty:_UseShadowThreshold,[HideInInspector][ToggleUI] _UseShadowThreshold("Use Shadow Threshold", Float) = 0
			...
			Option:Write Depth:false,true:false
				...
				true:ShowPort:Forward Unlit:Depth
				false,disable:RemoveDefine:ASE_DEPTH_WRITE_ON
				false,disable:HidePort:Forward Unlit:Depth
			...
			Option:  Depth Offset:false,true:false
				...
				true:ShowPort:Forward Unlit:Depth Offset
				false:RemoveDefine:_DEPTHOFFSET_ON
				false:HidePort:Forward Unlit:Depth Offset
		...
		*/
		...
		Pass
		{
			...
			struct PackedVaryingsMeshToPS
			{
				...
				/*ase_interp(1,):sp=sp.xyzw;rwp=tc1*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh /*ase_vert_input*/ )
			{
				...
				/*ase_vert_code:inputMesh=AttributesMesh;o=PackedVaryingsMeshToPS*/
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS o/*ase_vert_input*/ )
			{
		...
		Pass
		{
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput /*ase_frag_input*/ ) : SV_Target
			{
				...
				/*ase_local_var:rwp*/float3 PositionRWS = packedInput.positionRWS;
				/*ase_local_var:wvd*/float3 V = GetWorldSpaceNormalizeViewDir( packedInput.positionRWS );
				/*ase_local_var:sp*/float4 ClipPos = 0;
				/*ase_local_var:spu*/float4 ScreenPos = 0;
				...
				surfaceDescription.Distortion = /*ase_frag_out:Distortion;Float2;4;-1;_Distortion*/float2( 0, 0 )/*end*/;
				surfaceDescription.DistortionBlur = /*ase_frag_out:Distortion Blur;Float;5;-1;_DistortionBlur*/0/*end*/;
