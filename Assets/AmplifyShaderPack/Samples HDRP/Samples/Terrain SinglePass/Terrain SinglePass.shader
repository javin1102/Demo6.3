	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult993_g7 = (float4(cross( inputMesh.normalOS , float3( 0, 0, 1 ) ) , -1.0));
				
				float2 TecCoord01294_g7 = inputMesh.uv0.xy;
				float2 break291_g7 = _Control_ST.zw;
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( TecCoord01294_g7 * _Control_ST.xy ) + appendResult293_g7 );
				output.ase_texcoord5.xy = vertexToFrag286_g7;
				float2 break1393_g7 = _Control1_ST.zw;
				float2 appendResult1382_g7 = (float2(( break1393_g7.x + 0.001 ) , ( break1393_g7.y + 0.0001 )));
				float2 vertexToFrag1395_g7 = ( ( TecCoord01294_g7 * _Control1_ST.xy ) + appendResult1382_g7 );
				output.ase_texcoord6.xy = vertexToFrag1395_g7;
				...
				inputMesh.tangentOS = appendResult993_g7;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord5.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 TecCoord01294_g7 = packedInput.ase_texcoord5.zw;
				float3 Splat0342_g7 = (SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) )).rgb;
				float3 temp_output_35_0_g7 = ( (_DiffuseRemapScale0).xyz * Splat0342_g7 * _Splat0Brightness );
				float3 Splat1379_g7 = (SAMPLE_TEXTURE2D( _Splat1, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) )).rgb;
				float3 temp_output_38_0_g7 = ( (_DiffuseRemapScale1).xyz * Splat1379_g7 * _Splat1Brightness );
				float3 Splat2357_g7 = (SAMPLE_TEXTURE2D( _Splat2, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat2_ST.xy ) + _Splat2_ST.zw ) )).rgb;
				float3 temp_output_41_0_g7 = ( (_DiffuseRemapScale2).xyz * Splat2357_g7 * _Splat2Brightness );
				float3 Splat3390_g7 = (SAMPLE_TEXTURE2D( _Splat3, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat3_ST.xy ) + _Splat3_ST.zw ) )).rgb;
				float3 temp_output_44_0_g7 = ( (_DiffuseRemapScale3).xyz * Splat3390_g7 * _Splat3Brightness );
				float4 weightedBlendVar9_g7 = Control26_g7;
				float3 weightedBlend9_g7 = ( weightedBlendVar9_g7.x*temp_output_35_0_g7 + weightedBlendVar9_g7.y*temp_output_38_0_g7 + weightedBlendVar9_g7.z*temp_output_41_0_g7 + weightedBlendVar9_g7.w*temp_output_44_0_g7 );
				float2 vertexToFrag1395_g7 = packedInput.ase_texcoord6.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag1395_g7 );
				float3 Splat4752_g7 = (SAMPLE_TEXTURE2D( _Splat4, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) )).rgb;
				float3 temp_output_900_0_g7 = ( (_DiffuseRemapScale4).xyz * Splat4752_g7 * _Splat4Brightness );
				float3 Splat5743_g7 = (SAMPLE_TEXTURE2D( _Splat5, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) )).rgb;
				float3 temp_output_901_0_g7 = ( (_DiffuseRemapScale5).xyz * Splat5743_g7 * _Splat5Brightness );
				float3 Splat6759_g7 = (SAMPLE_TEXTURE2D( _Splat6, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat6_ST.xy ) + _Splat6_ST.zw ) )).rgb;
				float3 temp_output_919_0_g7 = ( (_DiffuseRemapScale6).xyz * Splat6759_g7 * _Splat6Brightness );
				float3 Splat7762_g7 = (SAMPLE_TEXTURE2D( _Splat7, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat7_ST.xy ) + _Splat7_ST.zw ) )).rgb;
				float3 temp_output_921_0_g7 = ( (_DiffuseRemapScale7).xyz * Splat7762_g7 * _Splat7Brightness );
				float4 weightedBlendVar912_g7 = Control1922_g7;
				float3 weightedBlend912_g7 = ( weightedBlendVar912_g7.x*temp_output_900_0_g7 + weightedBlendVar912_g7.y*temp_output_901_0_g7 + weightedBlendVar912_g7.z*temp_output_919_0_g7 + weightedBlendVar912_g7.w*temp_output_921_0_g7 );
				float3 localClipHoles453_g7 = ( ( weightedBlend9_g7 + weightedBlend912_g7 ) );
				float2 uv_TerrainHolesTexture451_g7 = packedInput.ase_texcoord5.zw;
				float Hole453_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 ).r;
				{
				#ifdef _ALPHATEST_ON
				clip(Hole453_g7 == 0.0005f? -1 : 1);
				#endif
				}
				float4 break2097_g7 = SAMPLE_TEXTURE2D( _Mask0, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) );
				float Mask0R334_g7 = break2097_g7.r;
				float4 break2193_g7 = SAMPLE_TEXTURE2D( _Mask1, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) );
				float Mask1R370_g7 = break2193_g7.r;
				float4 break2262_g7 = SAMPLE_TEXTURE2D( _Mask2, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat2_ST.xy ) + _Splat2_ST.zw ) );
				float Mask2R359_g7 = break2262_g7.r;
				float4 break2342_g7 = SAMPLE_TEXTURE2D( _Mask3, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat3_ST.xy ) + _Splat3_ST.zw ) );
				float Mask3R388_g7 = break2342_g7.r;
				float4 weightedBlendVar536_g7 = Control26_g7;
				float weightedBlend536_g7 = ( weightedBlendVar536_g7.x*( _Metallic0 * Mask0R334_g7 ) + weightedBlendVar536_g7.y*( _Metallic1 * Mask1R370_g7 ) + weightedBlendVar536_g7.z*( _Metallic2 * Mask2R359_g7 ) + weightedBlendVar536_g7.w*( _Metallic3 * Mask3R388_g7 ) );
				float4 break2413_g7 = SAMPLE_TEXTURE2D( _Mask4, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) );
				float Mask4R747_g7 = break2413_g7.r;
				float4 break2472_g7 = SAMPLE_TEXTURE2D( _Mask5, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) );
				float Mask5R741_g7 = break2472_g7.r;
				float4 break2531_g7 = SAMPLE_TEXTURE2D( _Mask6, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat6_ST.xy ) + _Splat6_ST.zw ) );
				float Mask6R755_g7 = break2531_g7.r;
				float4 break2590_g7 = SAMPLE_TEXTURE2D( _Mask7, sampler_Mask0, ( ( TecCoord01294_g7 * _Splat7_ST.xy ) + _Splat7_ST.zw ) );
				float Mask7R765_g7 = break2590_g7.r;
				float4 weightedBlendVar834_g7 = Control1922_g7;
				float weightedBlend834_g7 = ( weightedBlendVar834_g7.x*( _Metallic4 * Mask4R747_g7 ) + weightedBlendVar834_g7.y*( _Metallic5 * Mask5R741_g7 ) + weightedBlendVar834_g7.z*( _Metallic6 * Mask6R755_g7 ) + weightedBlendVar834_g7.w*( _Metallic7 * Mask7R765_g7 ) );
				float3 specularColor1792_g7 = (0).xxx;
				float oneMinusReflectivity1792_g7 = 0;
				float3 diffuseColor1792_g7 = ASEComputeDiffuseAndFresnel0( localClipHoles453_g7, ( weightedBlend536_g7 + weightedBlend834_g7 ), specularColor1792_g7, oneMinusReflectivity1792_g7 );
				
				float4 Normal0341_g7 = SAMPLE_TEXTURE2D( _Normal0, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) );
				float3 unpack490_g7 = UnpackNormalScale( Normal0341_g7, _NormalScale0 );
				unpack490_g7.z = lerp( 1, unpack490_g7.z, saturate(_NormalScale0) );
				float4 Normal1378_g7 = SAMPLE_TEXTURE2D( _Normal1, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) );
				float3 unpack496_g7 = UnpackNormalScale( Normal1378_g7, _NormalScale1 );
				unpack496_g7.z = lerp( 1, unpack496_g7.z, saturate(_NormalScale1) );
				float4 Normal2356_g7 = SAMPLE_TEXTURE2D( _Normal2, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat2_ST.xy ) + _Splat2_ST.zw ) );
				float3 unpack494_g7 = UnpackNormalScale( Normal2356_g7, _NormalScale2 );
				unpack494_g7.z = lerp( 1, unpack494_g7.z, saturate(_NormalScale2) );
				float4 Normal3398_g7 = SAMPLE_TEXTURE2D( _Normal3, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat3_ST.xy ) + _Splat3_ST.zw ) );
				float3 unpack491_g7 = UnpackNormalScale( Normal3398_g7, _NormalScale3 );
				unpack491_g7.z = lerp( 1, unpack491_g7.z, saturate(_NormalScale3) );
				float4 weightedBlendVar473_g7 = Control26_g7;
				float3 weightedBlend473_g7 = ( weightedBlendVar473_g7.x*unpack490_g7 + weightedBlendVar473_g7.y*unpack496_g7 + weightedBlendVar473_g7.z*unpack494_g7 + weightedBlendVar473_g7.w*unpack491_g7 );
				float4 Normal4746_g7 = SAMPLE_TEXTURE2D( _Normal4, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) );
				float3 unpack856_g7 = UnpackNormalScale( Normal4746_g7, _NormalScale4 );
				unpack856_g7.z = lerp( 1, unpack856_g7.z, saturate(_NormalScale4) );
				float4 Normal5740_g7 = SAMPLE_TEXTURE2D( _Normal5, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) );
				float3 unpack857_g7 = UnpackNormalScale( Normal5740_g7, _NormalScale5 );
				unpack857_g7.z = lerp( 1, unpack857_g7.z, saturate(_NormalScale5) );
				float4 Normal6754_g7 = SAMPLE_TEXTURE2D( _Normal6, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat6_ST.xy ) + _Splat6_ST.zw ) );
				float3 unpack858_g7 = UnpackNormalScale( Normal6754_g7, _NormalScale6 );
				unpack858_g7.z = lerp( 1, unpack858_g7.z, saturate(_NormalScale6) );
				float4 Normal7764_g7 = SAMPLE_TEXTURE2D( _Normal7, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat7_ST.xy ) + _Splat7_ST.zw ) );
				float3 unpack854_g7 = UnpackNormalScale( Normal7764_g7, _NormalScale7 );
				unpack854_g7.z = lerp( 1, unpack854_g7.z, saturate(_NormalScale7) );
				float4 weightedBlendVar860_g7 = Control1922_g7;
				float3 weightedBlend860_g7 = ( weightedBlendVar860_g7.x*unpack856_g7 + weightedBlendVar860_g7.y*unpack857_g7 + weightedBlendVar860_g7.z*unpack858_g7 + weightedBlendVar860_g7.w*unpack854_g7 );
				float3 break513_g7 = ( weightedBlend473_g7 + weightedBlend860_g7 );
				float3 appendResult514_g7 = (float3(break513_g7.x , break513_g7.y , ( break513_g7.z + 0.001 )));
				
				float4 weightedBlendVar1777_g7 = Control26_g7;
				float4 weightedBlend1777_g7 = ( weightedBlendVar1777_g7.x*_Specular0 + weightedBlendVar1777_g7.y*_Specular1 + weightedBlendVar1777_g7.z*_Specular2 + weightedBlendVar1777_g7.w*_Specular3 );
				float4 weightedBlendVar1773_g7 = Control1922_g7;
				float4 weightedBlend1773_g7 = ( weightedBlendVar1773_g7.x*_Specular4 + weightedBlendVar1773_g7.y*_Specular5 + weightedBlendVar1773_g7.z*_Specular6 + weightedBlendVar1773_g7.w*_Specular7 );
				
				float Mask0A335_g7 = break2097_g7.a;
				float Splat0A435_g7 = (SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) )).a;
				float lerpResult1509_g7 = lerp( Mask0A335_g7 , Splat0A435_g7 , _OpacityAsDensity0);
				float Mask1A369_g7 = break2193_g7.a;
				float Splat1A436_g7 = (SAMPLE_TEXTURE2D( _Splat1, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) )).a;
				float lerpResult1510_g7 = lerp( Mask1A369_g7 , Splat1A436_g7 , _OpacityAsDensity1);
				float Mask2A360_g7 = break2262_g7.a;
				float Splat2A438_g7 = (SAMPLE_TEXTURE2D( _Splat2, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat2_ST.xy ) + _Splat2_ST.zw ) )).a;
				float lerpResult1511_g7 = lerp( Mask2A360_g7 , Splat2A438_g7 , _OpacityAsDensity2);
				float Mask3A391_g7 = break2342_g7.a;
				float Splat3A440_g7 = (SAMPLE_TEXTURE2D( _Splat3, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat3_ST.xy ) + _Splat3_ST.zw ) )).a;
				float lerpResult1512_g7 = lerp( Mask3A391_g7 , Splat3A440_g7 , _OpacityAsDensity3);
				float4 weightedBlendVar547_g7 = Control26_g7;
				float weightedBlend547_g7 = ( weightedBlendVar547_g7.x*( _Smoothness0 * lerpResult1509_g7 ) + weightedBlendVar547_g7.y*( _Smoothness1 * lerpResult1510_g7 ) + weightedBlendVar547_g7.z*( _Smoothness2 * lerpResult1511_g7 ) + weightedBlendVar547_g7.w*( _Smoothness3 * lerpResult1512_g7 ) );
				float Mask4A750_g7 = break2413_g7.a;
				float Splat4A753_g7 = (SAMPLE_TEXTURE2D( _Splat4, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) )).a;
				float lerpResult1513_g7 = lerp( Mask4A750_g7 , Splat4A753_g7 , _OpacityAsDensity4);
				float Mask5A745_g7 = break2472_g7.a;
				float Splat5A739_g7 = (SAMPLE_TEXTURE2D( _Splat5, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) )).a;
				float lerpResult1514_g7 = lerp( Mask5A745_g7 , Splat5A739_g7 , _OpacityAsDensity5);
				float Mask6A758_g7 = break2531_g7.a;
				float Splat6A760_g7 = (SAMPLE_TEXTURE2D( _Splat6, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat6_ST.xy ) + _Splat6_ST.zw ) )).a;
				float lerpResult1515_g7 = lerp( Mask6A758_g7 , Splat6A760_g7 , _OpacityAsDensity6);
				float Mask7A768_g7 = break2590_g7.a;
				float Splat7A763_g7 = (SAMPLE_TEXTURE2D( _Splat7, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat7_ST.xy ) + _Splat7_ST.zw ) )).a;
				float lerpResult1516_g7 = lerp( Mask7A768_g7 , Splat7A763_g7 , _OpacityAsDensity7);
				float4 weightedBlendVar826_g7 = Control1922_g7;
				float weightedBlend826_g7 = ( weightedBlendVar826_g7.x*( _Smoothness4 * lerpResult1513_g7 ) + weightedBlendVar826_g7.y*( _Smoothness5 * lerpResult1514_g7 ) + weightedBlendVar826_g7.z*( _Smoothness6 * lerpResult1515_g7 ) + weightedBlendVar826_g7.w*( _Smoothness7 * lerpResult1516_g7 ) );
				
				float Mask0G409_g7 = break2097_g7.g;
				float lerpResult1655_g7 = lerp( ( _MaskMapRemapOffset0.y + _MaskMapRemapScale0.y ) , Mask0G409_g7 , _LayerHasMask0);
				float Mask1G371_g7 = break2193_g7.g;
				float lerpResult1660_g7 = lerp( ( _MaskMapRemapOffset1.y + _MaskMapRemapScale1.y ) , Mask1G371_g7 , _LayerHasMask1);
				float Mask2G358_g7 = break2262_g7.g;
				float lerpResult1663_g7 = lerp( ( _MaskMapRemapOffset2.y + _MaskMapRemapScale2.y ) , Mask2G358_g7 , _LayerHasMask2);
				float Mask3G389_g7 = break2342_g7.g;
				float lerpResult1666_g7 = lerp( ( _MaskMapRemapOffset3.y + _MaskMapRemapScale3.y ) , Mask3G389_g7 , _LayerHasMask3);
				float4 weightedBlendVar602_g7 = Control26_g7;
				float weightedBlend602_g7 = ( weightedBlendVar602_g7.x*saturate( lerpResult1655_g7 ) + weightedBlendVar602_g7.y*saturate( lerpResult1660_g7 ) + weightedBlendVar602_g7.z*saturate( lerpResult1663_g7 ) + weightedBlendVar602_g7.w*saturate( lerpResult1666_g7 ) );
				float Mask4G748_g7 = break2413_g7.g;
				float lerpResult1669_g7 = lerp( ( _MaskMapRemapOffset4.y + _MaskMapRemapScale4.x ) , Mask4G748_g7 , _LayerHasMask4);
				float Mask5G742_g7 = break2472_g7.g;
				float lerpResult1672_g7 = lerp( ( _MaskMapRemapOffset5.y + _MaskMapRemapScale5.y ) , Mask5G742_g7 , _LayerHasMask5);
				float Mask6G756_g7 = break2531_g7.g;
				float lerpResult1675_g7 = lerp( ( _MaskMapRemapOffset6.y + _MaskMapRemapScale6.y ) , Mask6G756_g7 , _LayerHasMask6);
				float Mask7G766_g7 = break2590_g7.g;
				float lerpResult1678_g7 = lerp( ( _MaskMapRemapOffset7.y + _MaskMapRemapScale7.y ) , Mask7G766_g7 , _LayerHasMask7);
				float4 weightedBlendVar799_g7 = Control1922_g7;
				float weightedBlend799_g7 = ( weightedBlendVar799_g7.x*saturate( lerpResult1669_g7 ) + weightedBlendVar799_g7.y*saturate( lerpResult1672_g7 ) + weightedBlendVar799_g7.z*saturate( lerpResult1675_g7 ) + weightedBlendVar799_g7.w*saturate( lerpResult1678_g7 ) );
				float Occlusion1868_g7 = saturate( ( weightedBlend602_g7 + weightedBlend799_g7 ) );
				
				float4 tex2DNode451_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 );
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = diffuseColor1792_g7;
				surfaceDescription.Normal = appendResult514_g7;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( specularColor1792_g7 + (( weightedBlend1777_g7 + weightedBlend1773_g7 )).xyz );
				#endif

				surfaceDescription.Smoothness = ( weightedBlend547_g7 + weightedBlend826_g7 );
				surfaceDescription.Occlusion = Occlusion1868_g7;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( 0.5 + 1E-37 );

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = ( 1.0 - tex2DNode451_g7 ).r;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( TecCoord01294_g7 * _Control_ST.xy ) + appendResult293_g7 );
				output.ase_texcoord2.xy = vertexToFrag286_g7;
				float2 break1393_g7 = _Control1_ST.zw;
				float2 appendResult1382_g7 = (float2(( break1393_g7.x + 0.001 ) , ( break1393_g7.y + 0.0001 )));
				float2 vertexToFrag1395_g7 = ( ( TecCoord01294_g7 * _Control1_ST.xy ) + appendResult1382_g7 );
				output.ase_texcoord3.xy = vertexToFrag1395_g7;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord2.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 TecCoord01294_g7 = packedInput.ase_texcoord2.zw;
				float3 Splat0342_g7 = (SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) )).rgb;
				float3 temp_output_35_0_g7 = ( (_DiffuseRemapScale0).xyz * Splat0342_g7 * _Splat0Brightness );
				float3 Splat1379_g7 = (SAMPLE_TEXTURE2D( _Splat1, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) )).rgb;
				float3 temp_output_38_0_g7 = ( (_DiffuseRemapScale1).xyz * Splat1379_g7 * _Splat1Brightness );
				...
				float4 weightedBlendVar9_g7 = Control26_g7;
				float3 weightedBlend9_g7 = ( weightedBlendVar9_g7.x*temp_output_35_0_g7 + weightedBlendVar9_g7.y*temp_output_38_0_g7 + weightedBlendVar9_g7.z*temp_output_41_0_g7 + weightedBlendVar9_g7.w*temp_output_44_0_g7 );
				float2 vertexToFrag1395_g7 = packedInput.ase_texcoord3.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag1395_g7 );
				float3 Splat4752_g7 = (SAMPLE_TEXTURE2D( _Splat4, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) )).rgb;
				float3 temp_output_900_0_g7 = ( (_DiffuseRemapScale4).xyz * Splat4752_g7 * _Splat4Brightness );
				float3 Splat5743_g7 = (SAMPLE_TEXTURE2D( _Splat5, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) )).rgb;
				...
				float3 weightedBlend912_g7 = ( weightedBlendVar912_g7.x*temp_output_900_0_g7 + weightedBlendVar912_g7.y*temp_output_901_0_g7 + weightedBlendVar912_g7.z*temp_output_919_0_g7 + weightedBlendVar912_g7.w*temp_output_921_0_g7 );
				float3 localClipHoles453_g7 = ( ( weightedBlend9_g7 + weightedBlend912_g7 ) );
				float2 uv_TerrainHolesTexture451_g7 = packedInput.ase_texcoord2.zw;
				float Hole453_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 ).r;
				{
				#ifdef _ALPHATEST_ON
				clip(Hole453_g7 == 0.0005f? -1 : 1);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_TerrainHolesTexture451_g7 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode451_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( TecCoord01294_g7 * _Control_ST.xy ) + appendResult293_g7 );
				output.ase_texcoord3.xy = vertexToFrag286_g7;
				float2 break1393_g7 = _Control1_ST.zw;
				float2 appendResult1382_g7 = (float2(( break1393_g7.x + 0.001 ) , ( break1393_g7.y + 0.0001 )));
				float2 vertexToFrag1395_g7 = ( ( TecCoord01294_g7 * _Control1_ST.xy ) + appendResult1382_g7 );
				output.ase_texcoord4.xy = vertexToFrag1395_g7;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord3.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 TecCoord01294_g7 = packedInput.ase_texcoord3.zw;
				float4 Normal0341_g7 = SAMPLE_TEXTURE2D( _Normal0, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) );
				float3 unpack490_g7 = UnpackNormalScale( Normal0341_g7, _NormalScale0 );
				unpack490_g7.z = lerp( 1, unpack490_g7.z, saturate(_NormalScale0) );
				float4 Normal1378_g7 = SAMPLE_TEXTURE2D( _Normal1, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) );
				...
				float4 weightedBlendVar473_g7 = Control26_g7;
				float3 weightedBlend473_g7 = ( weightedBlendVar473_g7.x*unpack490_g7 + weightedBlendVar473_g7.y*unpack496_g7 + weightedBlendVar473_g7.z*unpack494_g7 + weightedBlendVar473_g7.w*unpack491_g7 );
				float2 vertexToFrag1395_g7 = packedInput.ase_texcoord4.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag1395_g7 );
				float4 Normal4746_g7 = SAMPLE_TEXTURE2D( _Normal4, sampler_Normal0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) );
				float3 unpack856_g7 = UnpackNormalScale( Normal4746_g7, _NormalScale4 );
				unpack856_g7.z = lerp( 1, unpack856_g7.z, saturate(_NormalScale4) );
				...
				float2 uv_TerrainHolesTexture451_g7 = packedInput.ase_texcoord3.zw;
				float4 tex2DNode451_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				float2 TecCoord01294_g7 = inputMesh.ase_texcoord.xy;
				float2 break291_g7 = _Control_ST.zw;
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( TecCoord01294_g7 * _Control_ST.xy ) + appendResult293_g7 );
				output.ase_texcoord3.xy = vertexToFrag286_g7;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( TecCoord01294_g7 * _Control_ST.xy ) + appendResult293_g7 );
				output.ase_texcoord7.xy = vertexToFrag286_g7;
				float2 break1393_g7 = _Control1_ST.zw;
				float2 appendResult1382_g7 = (float2(( break1393_g7.x + 0.001 ) , ( break1393_g7.y + 0.0001 )));
				float2 vertexToFrag1395_g7 = ( ( TecCoord01294_g7 * _Control1_ST.xy ) + appendResult1382_g7 );
				output.ase_texcoord8.xy = vertexToFrag1395_g7;
					 ...
					 )
			{
				...
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord7.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 TecCoord01294_g7 = packedInput.ase_texcoord7.zw;
				float3 Splat0342_g7 = (SAMPLE_TEXTURE2D( _Splat0, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat0_ST.xy ) + _Splat0_ST.zw ) )).rgb;
				float3 temp_output_35_0_g7 = ( (_DiffuseRemapScale0).xyz * Splat0342_g7 * _Splat0Brightness );
				float3 Splat1379_g7 = (SAMPLE_TEXTURE2D( _Splat1, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat1_ST.xy ) + _Splat1_ST.zw ) )).rgb;
				float3 temp_output_38_0_g7 = ( (_DiffuseRemapScale1).xyz * Splat1379_g7 * _Splat1Brightness );
				...
				float4 weightedBlendVar9_g7 = Control26_g7;
				float3 weightedBlend9_g7 = ( weightedBlendVar9_g7.x*temp_output_35_0_g7 + weightedBlendVar9_g7.y*temp_output_38_0_g7 + weightedBlendVar9_g7.z*temp_output_41_0_g7 + weightedBlendVar9_g7.w*temp_output_44_0_g7 );
				float2 vertexToFrag1395_g7 = packedInput.ase_texcoord8.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag1395_g7 );
				float3 Splat4752_g7 = (SAMPLE_TEXTURE2D( _Splat4, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat4_ST.xy ) + _Splat4_ST.zw ) )).rgb;
				float3 temp_output_900_0_g7 = ( (_DiffuseRemapScale4).xyz * Splat4752_g7 * _Splat4Brightness );
				float3 Splat5743_g7 = (SAMPLE_TEXTURE2D( _Splat5, sampler_Splat0, ( ( TecCoord01294_g7 * _Splat5_ST.xy ) + _Splat5_ST.zw ) )).rgb;
				...
				float3 weightedBlend912_g7 = ( weightedBlendVar912_g7.x*temp_output_900_0_g7 + weightedBlendVar912_g7.y*temp_output_901_0_g7 + weightedBlendVar912_g7.z*temp_output_919_0_g7 + weightedBlendVar912_g7.w*temp_output_921_0_g7 );
				float3 localClipHoles453_g7 = ( ( weightedBlend9_g7 + weightedBlend912_g7 ) );
				float2 uv_TerrainHolesTexture451_g7 = packedInput.ase_texcoord7.zw;
				float Hole453_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture451_g7 ).r;
				{
				#ifdef _ALPHATEST_ON
				clip(Hole453_g7 == 0.0005f? -1 : 1);
