...
- Built quest using R3 and PixelCrusher Dialogue System
- Explore Reflex for DI
- Explore Odin Serializer and Inspector
- Explore Unity New Input System
- Explore Unity UI Toolkit
- Learn how to built a project that can be easily tested using autmation testing
